...
MENUS = [
    ...
    ('mcd_burger_02', 'mcd', '맥스파이시 상하이 버거', 'burger', 5900, 6800, '2026-02-28', 464, None, '시그니처,매운,인기', 0, 0),
    ...
    ('bk_burger_06', 'bk', '콰트로 치즈 와퍼', 'burger', 8200, 9200, '2026-03-01', 769, None, '시그니처,프리미엄', 0, 0),
    ...
    ('kfc_burger_02', 'kfc', '징거타워버거', 'burger', 6900, 7200, '2026-02-28', 680, None, '시그니처,인기', 0, 0),
    ...
    ('kfc_set_02', 'kfc', '징거타워버거 세트', 'set', 8900, 9400, '2026-02-28', 1160, None, '시그니처,인기', 1, 1),
    ...
    ('mom_burger_02', 'mom', '불싸이버거', 'burger', 5400, 6400, '2026-03-01', 620, None, '시그니처,매운,인기', 0, 0),
    ...
    ('lot_burger_02', 'lot', '리아 새우', 'burger', 5000, 5800, '2026-03-01', 420, None, '시그니처,인기', 0, 0),
